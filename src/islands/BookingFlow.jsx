              ...
              {servicios.map(s => (
                ...
                >
                  <div>
                    ...
                    <p style={{ fontFamily: "'Lato', sans-serif", fontSize: '0.75rem', color: '#666', margin: '0.2rem 0 0' }}>⏱ {s.duracion_min ?? 60} min</p>
                  </div>
      ...
      {paso === 4 && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          ...
          <div style={{ background: 'rgba(186, 143, 87, 0.05)', border: '1px solid rgba(186, 143, 87, 0.25)', borderRadius: '1rem', padding: '1.25rem' }}>
            <p style={{ margin: '0 0 0.25rem 0', fontFamily: "'Lato', sans-serif", fontSize: '0.72rem', color: '#888' }}>RESUMEN DE TU SELECCIÓN</p>
          ...
          <div style={{ background: '#111', border: '1px solid rgba(186,143,87,0.18)', borderRadius: '1rem', padding: '1.5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.5rem', marginBottom: '1.5rem' }}>
              ...
              {pagosConfig.pago_movil_activo && (
                ...
                >
                  ...
                  <span style={{ fontSize: '0.72rem', fontWeight: 'bold', fontFamily: "'Urbanist', sans-serif", textTransform: 'uppercase' }}>Pago Móvil</span>
                </button>
              )}
              ...
              {pagosConfig.zelle_activo && (
                ...
                >
                  <span style={{ fontSize: '1.3rem' }}>💚</span>
                  <span style={{ fontSize: '0.72rem', fontWeight: 'bold', fontFamily: "'Urbanist', sans-serif", textTransform: 'uppercase' }}>Zelle</span>
                </button>
              )}
              ...
              {pagosConfig.efectivo_activo && (
                ...
                >
                  <span style={{ fontSize: '1.3rem' }}>💵</span>
                  <span style={{ fontSize: '0.72rem', fontWeight: 'bold', fontFamily: "'Urbanist', sans-serif", textTransform: 'uppercase' }}>Efectivo</span>
                </button>
              )}
            </div>
            ...
            {metodoPago === 'zelle' && (
              <div style={{ background: '#0a0a0a', border: '1px solid rgba(186,143,87,0.15)', borderRadius: '0.75rem', padding: '1.25rem', marginBottom: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem', marginBottom: '1rem', fontSize: '0.78rem', color: '#ccc' }}>
                  <div>
                    <span style={{ display: 'block', fontSize: '0.65rem', color: '#555' }}>CORREO ELECTRÓNICO:</span>
                    <strong>{pagosConfig.zelle_correo || 'pagos@chikiluky.app'}</strong>
                  </div>
                  <div>
                    <span style={{ display: 'block', fontSize: '0.65rem', color: '#555' }}>TITULAR DE LA CUENTA:</span>
                    <strong>{pagosConfig.zelle_titular || 'Chikiluky Barbershop'}</strong>
                  </div>
                </div>
            ...
            {/* Formulario Efectivo */}
            {metodoPago === 'efectivo' && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', background: 'rgba(186,143,87,0.08)', border: '1px solid rgba(186,143,87,0.25)', borderRadius: '0.75rem', padding: '1rem', marginBottom: '1.5rem' }}>
                <span style={{ fontSize: '1.5rem' }}>💵</span>
                <p style={{ margin: 0, fontFamily: "'Lato', sans-serif", fontSize: '0.78rem', color: '#ccc', lineHeight: '1.4' }}>
                  <strong>Aviso Flotante:</strong> Pagarás el equivalente de tu cita de forma directa en efectivo en el local el día de la cita.
                </p>
              </div>
            )}
            ...
            {/* Mensaje de Error */}
            {errorMsg && (
              <div style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.3)', borderRadius: '0.5rem', padding: '0.75rem', color: '#ef4444', fontSize: '0.78rem', marginBottom: '1rem', textAlign: 'center' }}>
                ⚠️ {errorMsg}
              </div>
            )}
